...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Luna_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("5c9374ce-fdac-595e-b98d-9d97a97a2302"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Luna", artifacts_toml) for e in artifacts["Luna"]]
...
if best_platform === nothing
    @debug("Unable to load Luna; unsupported platform $(triplet(platform_key_abi()))")
else
